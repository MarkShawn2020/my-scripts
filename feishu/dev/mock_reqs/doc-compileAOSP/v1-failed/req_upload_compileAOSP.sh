#!/usr/bin/env bash
curl -H "Host: internal-api-drive-stream.feishu.cn" \
-H "sec-ch-ua: \"Chromium\";v=\"104\", \" Not A;Brand\";v=\"99\", \"Google Chrome\";v=\"104\"" \
-H "DNT: 1" -H "X-TT-LOGID: 02166236122486300000000000000000000ffff3a65a882c7968d" \
...
--data-binary "------WebKitFormBoundary8gOXf8R1qwQ2O3OQ
...
------WebKitFormBoundary8gOXf8R1qwQ2O3OQ--
