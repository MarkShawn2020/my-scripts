...
filePath = "test-pure-md.md"
fileKey = path.basename(filePath)
fileSize = getFileSize(filePath)
console.log({fileKey, fileSize})

const url = "https://internal-api-drive-stream.feishu.cn/space/api/box/stream/upload/all/" +
  `?name=${fileKey}` +
  `&size=${fileSize}` +
  "&checksum=2846231082" +
  "&mount_node_token=wikcnhKiTGCVdgWqMmfJn7y1Xqh&mount_point=wiki" +
